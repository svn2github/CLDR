...
public class WebContext implements Cloneable, Appendable {
     ...
     * @return the map
     */
    public CheckCLDR.Options getOptionsMap(CheckCLDR.Options options) {
        String def = getRequiredCoverageLevel();
        String org = getEffectiveCoverageLevel();
        
        return options.set(CheckCLDR.Options.Option.CoverageLevel_requiredLevel, def)
                      .set(CheckCLDR.Options.Option.CoverageLevel_localeType, org);
    }
